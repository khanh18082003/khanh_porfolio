        ...
        <div className="mt-16 grid grid-cols-1 items-start gap-16 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="space-y-6 border-l-2 border-emerald-100 pl-6 text-lg leading-relaxed text-slate-600 dark:border-emerald-900/30 dark:text-slate-400">
              <p>
                With over 5 years of professional experience, my career has been
                defined by a deep-seated passion for the invisible yet vital
                infrastructure that powers the modern web. I specialize in
                building high-performance backend architectures that remain
                resilient under pressure.
              </p>
              <p>
                I thrive on the complexity of{" "}
                <strong className="text-slate-900 dark:text-slate-100">
                  distributed systems
                </strong>{" "}
                and the meticulous craft of database optimization. From
                migrating legacy monoliths to microservices to implementing
                real-time data pipelines, I focus on creating systems that are
                not just fast, but transparent and maintainable.
              </p>
              <p>
                My approach combines rigorous software engineering principles
                with a curiosity for emerging cloud-native technologies,
                ensuring that every project I architect is built to scale
                alongside ambitious business goals.
              </p>
            </div>
          </div>
